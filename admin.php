...
<body>
    ...
    <div class="adminForms">
        <div class="form" id="addOrganizationForm">
            ...
            <form class="adminInputForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                onsubmit="return checkAddOrg();">
                <p class="errorMsg" id="addOrganizationNameError"></p>
                <label for="addOrganizationName">Name of Organization:</label>
                <input type="text" id="addOrganizationName" name="addOrganizationName"
                    placeholder="Women in Computer Science and Engineering"><br>
                ...
                <input type="text" id="addOrganizationAbbreviation" name="addOrganizationAbbreviation"
                    placeholder="WiCSE"><br>
                <p class="errorMsg" id="addOrganizationEmailError"></p>
                <label for="addOrganizationEmail">President's Email</label>
                <input type="text" id="addOrganizationEmail" name="addOrganizationEmail"
                    placeholder="albert@ufl.edu"><br>
                <input type="submit" class="submitAdmin" id="addOrganizationSubmit" name="addOrganizationSubmit"
                    value="Submit">
            </form>
        </div>
        ...
        <div class="form" id="addPresidentForm">
            ...
            <form class="adminInputForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                ...
                <input type="submit" class="submitAdmin" id="addPresidentSubmit" name="addPresidentSubmit"
                    value="Submit">
            </form>
        ...
        <div class="form" id="removePresidentForm">
            ...
            <form class="adminInputForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                onsubmit="return checkRemovePres();">
                ...
                <input type="text" id="removePresidentEmail" name="removePresidentEmail"
                    placeholder="albert@ufl.edu"><br>
                <input type="submit" class="submitAdmin" id="removePresidentSubmit" name="removePresidentSubmit"
                    value="Submit">
            </form>
        </div>
        ...
        <div class="form" id="changePresidentForm">
            ...
            <form class="adminInputForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                onsubmit="return checkChangePres();">
                ...
                <input type="text" id="changePresidentOldEmail" name="changePresidentOldEmail"
                    placeholder="albert@ufl.edu"><br>
                <p class="errorMsg" id="changePresidentEmailErrorNew"></p>
                <label for="changePresidentNewEmail">New President's Email</label>
                <input type="text" id="changePresidentNewEmail" name="changePresidentNewEmail"
                    placeholder="newAlbert@ufl.edu"><br>
                <input type="submit" class="submitAdmin" id="changePresidentSubmit" name="changePresidentSubmit"
                    value="Submit">
            </form>
        </div>
        ...
        <div class="form" id="deleteOrganizationForm">
            ...
            <form class="adminInputForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                onsubmit="return removeOrganization();">
                ...
                <input type="submit" class="submitAdmin" id="removeOrganizationSubmit" name="removeOrganizationSubmit"
                    value="Submit">
            </form>
        </div>
        ...
        <div class="form" id="modifyAdministrationForm">
            ...
            <form class="adminInputForm" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                ...
                <input type="submit" class="submitAdmin" id="modifyAdminAccessSubmit" name="modifyAdminAccessSubmit"
                    value="Submit">
            </form>
        </div>
    </div>
